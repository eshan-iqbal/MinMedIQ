...
import { PlusCircle, Printer, Trash2, UserPlus, ChevronsUpDown, Check, Plus, RefreshCw } from 'lucide-react';
                       ...
                       >
                         <div className="flex-1">
                           ...
                           <div className="text-sm text-gray-500">
                             {med.isPillBased ? (
                               <>
                                 <Currency amount={med.stripPrice || 0} />/strip ({med.pillsPerStrip} pills) - Stock: {med.stock} strips
                               </>
                             ) : (
                               <>
                                 <Currency amount={med.price} /> - Stock: {med.stock}
                               </>
                             )}
                           </div>
                         </div>
                      ...
                      <TableCell className="font-medium">
                        ...
                        {isPillBased && (
                          <div className="text-xs text-muted-foreground">
                            {pillsPerStrip} pills/<Currency amount={stripPrice} />
                          </div>
                        )}
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-right">
                        {isPillBased ? (
                          <div className="text-xs">
                            <div><Currency amount={unitPrice} />/pill</div>
                            <div className="text-muted-foreground"><Currency amount={stripPrice} />/strip</div>
                          </div>
                        ) : (
      ...
      <Card className="lg:col-span-3 h-fit">
        ...
        <CardContent className="grid gap-4">
          <div className="flex justify-between">
           ...
           <div className="flex items-center justify-between">
            <Label htmlFor="tax" className='flex-1'>Tax Rate (%)</Label>
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="discount" className='flex-1'>Discount (<CurrencySymbol />)</Label>
          ...
          <div className="flex justify-between font-semibold text-lg">
            ...
            <span><Currency amount={grandTotal} /></span>
          </div>
        </CardContent>
