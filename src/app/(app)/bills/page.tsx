...
import { MoreHorizontal, Printer, Eye, Search, Trash2 } from 'lucide-react';
                ...
                filteredBills.map((bill) => (
                  <TableRow key={bill._id}>
                    ...
                    <TableCell>{bill.items.length} items</TableCell>
                                         <TableCell><Currency amount={bill.grandTotal} /></TableCell>
                    <TableCell>
          ...
          {selectedBill && (
            <div className="space-y-4">
              ...
              <div className="border-t pt-4 space-y-2">
                   ...
                   <span>Subtotal:</span>
                   <span><Currency amount={selectedBill.subtotal} /></span>
                 </div>
                                 <div className="flex justify-between">
                   <span>Tax ({selectedBill.tax}%):</span>
                   <span><Currency amount={selectedBill.taxAmount} /></span>
                 </div>
                                 <div className="flex justify-between">
                   <span>Discount:</span>
                   <span>-<Currency amount={selectedBill.discount} /></span>
                 </div>
                                 <div className="flex justify-between font-semibold text-lg">
                   <span>Grand Total:</span>
                   <span><Currency amount={selectedBill.grandTotal} /></span>
                 </div>
              </div>
